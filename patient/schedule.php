...
// Check booked dates for the patient
$appointment_check_sql = "SELECT DISTINCT appointment.scheduledate FROM appointment INNER JOIN schedule ON appointment.scheduleid = schedule.scheduleid WHERE appointment.pid = ?";
