...
<body>
    ...
    $userid = $userfetch["ptid"]; // Changed from docid to ptid
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="?action=archive&id=<?php echo $userid.'&name='.$username ?>" class="non-style-link">
                                    <div class="dashboard-items setting-tabs" style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/patients-hover.svg');"></div>
                                        <div>
                                            <div class="h1-dashboard" style="color: #ff5050;">Archive Account</div><br>
                                            <div class="h3-dashboard" style="font-size: 15px;">Will Archive your Account (Reversible by Admin)</div>
                                        </div>
                                    </div>
                                    </a>
                                </td>
    ...
    if ($_GET) {
        ...
        if ($action == 'archive') {
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        ...
                        <div class="content">
                            You want to archive this account<br>('.substr($nameget, 0, 40).').<br>This will hide your account until an admin unarchives it.
                        </div>
                        <div style="display: flex;justify-content: center;">
                            <a href="archive-doctor.php?id='.$id.'&status=1" class="non-style-link"><button class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text"> Yes </font></button></a>
            ...
            $sqlmain = "SELECT * FROM doctor WHERE ptid='$id'"; // Changed from docid to ptid
            ...
            $nic = $row['docnic'] ?? 'N/A'; // Handle potential null value
            $tele = $row['doctel'];
            echo '
            <div id="popup1" class="overlay">
                <div class="popup">
            ...
            $nic = $row['docnic'] ?? 'N/A'; // Handle potential null value
            $tele = $row['doctel'];
            $ptid = $row['ptid']; // Fetch ptid for display
                                    ...
                                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                Doctor ID: '.$ptid.'<br><br> <!-- Changed to use ptid -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label-td" colspan="2">
